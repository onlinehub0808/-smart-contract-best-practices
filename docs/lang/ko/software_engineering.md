...
써킷 브레이커는 특정 조건이 만족될 경우 컨트랙트의 실행을 중지시키고 새로운 에러가 발견되었을 때 유용하게 사용될 수 있습니다. 예를 들어, 버그가 발견되었을 경우 대부분의 액션을 중지하고, 출금만 가능하도록 할 수 있습니다. 또한 특정한 신뢰 가능한 참가측을 서킷 브레이커를 발동할 수 있도록 권한을 주거나 자동으로 실행될 수 있도록 프로그램적인 규칙을 둘 수도 있습니다.
